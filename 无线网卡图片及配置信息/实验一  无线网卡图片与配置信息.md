...
```
### 遇到的问题（已解决）
- 刚开始连接无线网卡的时候，虚拟机显示“无法将usb分配到kali虚拟机”
- 后在网上查阅文档，在注册表编辑器中：进入```\HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Class\{36fc9e60-c465-11cf-8056-444553540000}```目录下，将USBPcap项删除，即可解决（USBPcap应该是在安装WireShark时一起安装的）
